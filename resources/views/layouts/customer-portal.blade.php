...
<head>
    ...
    <title>@yield('title', 'Customer Portal — Iimaan Dry Cleaner')</title>
...
<body>
    ...
    <!-- Secondary Slim Sub-navigation bar -->
    <div style="background:#f1f5f9; border-bottom: 1px solid #e2e8f0; padding:0.5rem 0;">
        <div class="container">
            <div class="d-flex gap-3 overflow-auto">
                <a href="{{ route('customer.orders.index') }}" class="portal-nav-link {{ request()->routeIs('customer.orders*') ? 'active' : '' }}">
                    <i class="fas fa-shopping-bag me-1"></i>My Orders
                </a>
                <a href="{{ route('customer.payments.index') }}" class="portal-nav-link {{ request()->routeIs('customer.payments*') ? 'active' : '' }}">
                    <i class="fas fa-credit-card me-1"></i>Payments
                </a>
                <a href="{{ route('customer.reviews.index') }}" class="portal-nav-link {{ request()->routeIs('customer.reviews*') ? 'active' : '' }}">
                    <i class="fas fa-star me-1"></i>My Reviews
                </a>
                <a href="{{ route('customer.support.index') }}" class="portal-nav-link {{ request()->routeIs('customer.support*') ? 'active' : '' }}">
                    <i class="fas fa-headset me-1"></i>Support
                </a>
                <a href="{{ route('customer.notifications.index') }}" class="portal-nav-link {{ request()->routeIs('customer.notifications*') ? 'active' : '' }}">
                    ...
                    @if($unreadNotificationsCount > 0)
                        <span class="badge bg-danger rounded-pill ms-1 small">{{ $unreadNotificationsCount }}</span>
                    @endif
                </a>
                <a href="{{ route('customer.profile.edit') }}" class="portal-nav-link {{ request()->routeIs('customer.profile*') ? 'active' : '' }}">
