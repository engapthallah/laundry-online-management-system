...
<div class="container py-2">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <a href="{{ route('admin.support.export', request()->query()) }}" class="btn btn-success fw-bold px-3 py-2 rounded-3 shadow-sm">
        ...
        <div class="card-body p-4">
            <form method="GET" action="{{ route('admin.support.index') }}" class="row g-3 align-items-end">
                ...
                <div class="col-lg-2 col-md-6 d-flex gap-2">
                    ...
                    <a href="{{ route('admin.support.index') }}" class="btn btn-outline-secondary w-100 fw-bold" title="Clear All Filters">
                        Clear
                    </a>
                </div>
            </form>
                            ...
                            <tr class="{{ $rowClass }}">
                                ...
                                <td class="px-4 text-end">
                                    <div class="d-inline-flex gap-2">
                                        @if($message->status === 'pending')
                                            <a href="{{ route('admin.support.show', $message) }}" class="btn btn-warning btn-sm fw-bold rounded-pill px-3 shadow-sm">
                                                <i class="fa-solid fa-reply me-1"></i>Reply
                                            </a>
                                        @endif
                                        <a href="{{ route('admin.support.show', $message) }}" class="btn btn-outline-primary btn-sm fw-bold rounded-pill px-3">
                                            View
                                        </a>
                                    </div>
                                </td>
