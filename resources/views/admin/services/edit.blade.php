...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-4 border-bottom">
    <h1 class="h2 fw-bold text-dark">Edit Service</h1>
        ...
        <form method="POST" action="{{ route('admin.services.update', $service->id) }}">
            ...
            <div class="row g-4">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $service->name) }}" required placeholder="e.g. Dry Cleaning">
                    @error('name')
                ...
                <div class="col-12 col-md-6 d-flex align-items-center">
                    <div class="form-check form-switch mt-4">
                        ...
                        <label class="form-check-label fw-semibold ms-2" for="is_active">Service Active</label>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" step="0.01" min="0" name="price_per_kg" id="price_per_kg" class="form-control @error('price_per_kg') is-invalid @enderror" value="{{ old('price_per_kg', $service->price_per_kg) }}" required>
                        @error('price_per_kg')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-12 col-md-6">
                    ...
                    <div class="input-group">
                        <span class="input-group-text">$</span>
                        <input type="number" step="0.01" min="0" name="price_per_item" id="price_per_item" class="form-control @error('price_per_item') is-invalid @enderror" value="{{ old('price_per_item', $service->price_per_item) }}" required>
                ...
                <div class="col-12">
                    ...
                    <textarea name="description" id="description" rows="4" class="form-control @error('description') is-invalid @enderror" placeholder="Describe the details of this laundry service...">{{ old('description', $service->description) }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
