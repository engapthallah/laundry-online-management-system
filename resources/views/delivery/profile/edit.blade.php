...
<div class="row mb-4">
    <div class="col-12">
        ...
        <p class="text-secondary mb-0">Manage your personal details, transit vehicle information, and security options.</p>
    </div>
</div>
    ...
    <div class="col-12 col-lg-7">
        <div class="card border-0 shadow-sm rounded-3 bg-white p-4 h-100">
            ...
            <form method="POST" action="{{ route('delivery.profile.update') }}">
                ...
                <!-- Phone Field -->
                <div class="mb-3">
                    <label for="phone" class="form-label fw-semibold text-secondary">Contact Number (used for delivery coordination)</label>
                ...
                <!-- Vehicle Info Field -->
                <div class="mb-3">
                    <label for="vehicle_info" class="form-label fw-semibold text-secondary">Vehicle Information (used for dispatch details)</label>
                    <input type="text" class="form-control bg-light @error('vehicle_info') is-invalid @enderror" id="vehicle_info" name="vehicle_info" value="{{ old('vehicle_info', $user->vehicle_info) }}" placeholder="e.g. Toyota Prius KAB-1234, Honda Motorcycle">
                    @error('vehicle_info')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <!-- Address Field -->
                <div class="mb-4">
                    <label for="address" class="form-label fw-semibold text-secondary">Home Base Address</label>
    ...
    <div class="col-12 col-lg-5">
        <div class="card border-0 shadow-sm rounded-3 bg-white p-4 h-100">
            ...
            <form method="POST" action="{{ route('delivery.profile.update') }}">
                ...
                <input type="hidden" name="vehicle_info" value="{{ old('vehicle_info', $user->vehicle_info) }}">
