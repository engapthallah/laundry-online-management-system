...
class NotificationController extends Controller
{
    ...
    {
        // Admin can view all notifications across all users for audit trail
        $query = Notification::with(['order', 'user']);
    ...
    {
        // Ownership Check: must belong to the authenticated admin
    ...
    public function markAllRead(): RedirectResponse
    {
        ...
        return redirect()->back()->with('success', 'All your notifications have been marked as read.');
    }
}
